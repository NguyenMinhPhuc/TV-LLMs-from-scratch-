...
> Glossary: see [`GLOSSARY.md`](GLOSSARY.md) for standardized terminology (LLM, reasoning, inference-time scaling, distillation, etc.).
...
For consistent term usage across translations, consult the glossary in [`GLOSSARY.md`](GLOSSARY.md).
